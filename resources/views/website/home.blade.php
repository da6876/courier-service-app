...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
      <title>{{ strtoupper(config('app.name')) }} | Home</title>


    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('assets/website/assets/img/favicons/apple-touch-icon.png')}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('assets/website/assets/img/favicons/favicon-32x32.png')}}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/website/assets/img/favicons/favicon-16x16.png')}}">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('assets/website/assets/img/favicons/favicon.ico')}}">
    <link rel="manifest" href="{{asset('assets/website/assets/img/favicons/manifest.json')}}">
    <meta name="msapplication-TileImage" content="{{asset('assets/website/assets/img/favicons/mstile-150x150.png')}}">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{asset('assets/website/assets/css/theme.css')}}" rel="stylesheet" />
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="{{url('/')}}"><img src="{{asset('assets/images/logo.png')}}" height="45" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <a href="{{url('login')}}" class="btn btn-primary order-1 order-lg-0 ms-lg-3" href="#!">Login</a>
            <a href="{{url('registration')}}" class="btn btn-info text-white order-1 order-lg-0 ms-lg-3" href="#!">Registration</a>
      ...
      <section class="py-xxl-10 pb-0" id="home">
        <div class="bg-holder bg-size" style="background-image:url({{asset('assets/website/assets/img/gallery/hero-header-bg.png')}});background-position:top center;background-size:cover;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-5 col-xl-6 col-xxl-7 order-0 order-md-1 text-end"><img class="pt-7 pt-md-0 w-100" src="{{asset('assets/website/assets/img/illustrations/hero.png')}}" alt="hero-header" /></div>
            <div class="col-md-75 col-xl-6 col-xxl-5 text-md-start text-center py-8">
              ...
              <p class="fs-1 mb-5">We deliver your products safely to <br />your home in a reasonable time. </p><a class="btn btn-primary me-2" href="#!" role="button">Track Order<i class="fas fa-arrow-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="row h-100 justify-content-center">
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{asset('assets/website/assets/img/icons/services-1.svg')}}" alt="..." />
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{asset('assets/website/assets/img/icons/services-2.svg')}}" alt="..." />
            ...
            <div class="col-md-4 pt-4 px-md-2 px-lg-3">
              <div class="card h-100 px-lg-5 card-span">
                <div class="card-body d-flex flex-column justify-content-around">
                  <div class="text-center pt-5"><img class="img-fluid" src="{{asset('assets/website/assets/img/icons/services-3.svg')}}" alt="..." />
        ...
        <div class="container">
          <div class="row">
            <div class="col-6 col-lg mb-5">
              <div class="text-center"><img src="{{asset('assets/website/assets/img/icons/awards.png')}}" alt="..." />
                <h1 class="text-primary mt-4">26+</h1>
                <h5 class="text-800">Awards won</h5>
              </div>
            </div>
            <div class="col-6 col-lg mb-5">
              <div class="text-center"><img src="{{asset('assets/website/assets/img/icons/states.png')}}" alt="..." />
                <h1 class="text-primary mt-4">65+</h1>
                <h5 class="text-800">States covered</h5>
              </div>
            </div>
            <div class="col-6 col-lg mb-5">
              <div class="text-center"><img src="{{asset('assets/website/assets/img/icons/clients.png')}}" alt="..." />
                <h1 class="text-primary mt-4">689K+</h1>
                <h5 class="text-800">Happy clients</h5>
              </div>
            </div>
            <div class="col-6 col-lg mb-5">
              <div class="text-center"><img src="{{asset('assets/website/assets/img/icons/goods.png')}}" alt="..." />
                <h1 class="text-primary mt-4">130M+</h1>
                <h5 class="text-800">Goods delivered</h5>
              </div>
            </div>
            <div class="col-6 col-lg mb-5">
              <div class="text-center"><img src="{{asset('assets/website/assets/img/icons/business.png')}}" alt="..." />
                <h1 class="text-primary mt-4">130M+</h1>
      ...
      <section>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="card bg-dark text-white py-4 py-sm-0"><img class="w-100" src="{{asset('assets/website/assets/img/gallery/video.png')}}" alt="video" />
                <div class="card-img-overlay bg-dark-gradient d-flex flex-column flex-center"><img src="{{asset('assets/website/assets/img/icons/play.png')}}" width="80" alt="play" />
      ...
      <section class="py-7">
        ...
        <div class="container-fluid">
          <div class="row flex-center">
            <div class="bg-holder bg-size" style="background-image:url({{asset('assets/website/assets/img/gallery/quote.png')}});background-position:top;background-size:auto;margin-left:-270px;margin-top:-45px;">
            </div>
            <!--/.bg-holder-->
                    ...
                    <div class="card h-100 card-span p-3">
                      <div class="card-body">
                        ...
                        <div class="d-xl-flex justify-content-between align-items-center">
                          ...
                          <div class="d-flex align-items-center"><img class="img-fluid" src="{{asset('assets/website/assets/img/icons/avatar.png')}}" alt="" />
      ...
      <section>
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-6 col-lg-5 col-xl-4"><img src="{{asset('assets/website/assets/img/illustrations/callback.png')}}" alt="..." />
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-12">
              <div class="card card-span rounded-2 mb-3">
                <div class="row">
                  <div class="col-md-6 col-lg-7 d-flex"><img class="w-100 fit-cover rounded-md-start rounded-top rounded-md-top-0" src="{{asset('assets/website/assets/img/gallery/map.svg')}}" alt="map" /></div>
      ...
      <section class="bg-900 pb-0 pt-5">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="{{asset('assets/images/logo.png')}}" height="51" alt="" /></a>
          ...
          <div class="row justify-content-md-between justify-content-evenly py-4">
            ...
            <div class="col-12 col-sm-8 col-md-6">
              <p class="fs--1 my-2 text-center text-md-end text-200"> Made with&nbsp;
                ...
                </svg>&nbsp;by&nbsp;<a class="fw-bold text-primary" href="https://sourceofcapacity.com/" target="_blank">Source Of Capacity </a>
              </p>
            </div>
          </div>
        </div>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{asset('assets/website/vendors/@popperjs/popper.min.js')}}"></script>
    <script src="{{asset('assets/website/vendors/bootstrap/bootstrap.min.js')}}"></script>
    <script src="{{asset('assets/website/vendors/is/is.min.js')}}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{asset('assets/website/vendors/fontawesome/all.min.js')}}"></script>
    <script src="{{asset('assets/website/assets/js/theme.js')}}"></script>
